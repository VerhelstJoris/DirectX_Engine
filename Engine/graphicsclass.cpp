...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd, const GameContext& context, GraphicsScenes sceneSelect)
{
	bool result;
	D3DXMATRIX baseViewMatrix;
	m_SceneSelect = sceneSelect;
...
#pragma region RESOURCELOADING
	...
	m_ResourceLoader.LoadTexture(m_D3D->GetDevice(), TextureID::T_RED, L"../Engine/data/Textures/T_Red.png");
...
#pragma endregion
	...
	extern GraphicsScenes G_sceneMode;
...
#pragma endregion
	...
	if (m_SceneSelect == GraphicsScenes::TERRAIN)
	{
